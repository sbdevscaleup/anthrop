import { AccountDeletion } from "@/app/(dashboard)/dashboard/profile/_components/account-deletion";
import { AccountLinking } from "@/app/(dashboard)/dashboard/profile/_components/account-linking";
import { ChangePasswordForm } from "@/app/(dashboard)/dashboard/profile/_components/change-password-form";
import { ProfileUpdateForm } from "@/app/(dashboard)/dashboard/profile/_components/profile-update-form";
import { SessionManagement } from "@/app/(dashboard)/dashboard/profile/_components/session-management";
import { SetPasswordButton } from "@/app/(dashboard)/dashboard/profile/_components/set-password-button";
